...
def parse_args():
    ...
    parser.add_argument("--n_steps", type=float, default=10e6)# quantidade de epocas (partidas)
    parser.add_argument("--n_workers", type=int, default=1) #quantidade de workes (threds)
    parser.add_argument("--ckpt_interval_seconds", type=int, default=300) #intervalos de tempo para salvar o mode atual da rede
    parser.add_argument("--load_ckpt") # código para iniciar o treinamento a partir de um modelo de rede salva de um treinamento anterior
    parser.add_argument("--seed", type=int, default=0) # valor base para geração de nnúmero aleatórios
    parser.add_argument("--max_n_noops", type=int, default=30) # quantidade de passos aleatórios que são executados no inicio de cada epsódio
    ...
    parser.add_argument("--preprocessing",
                        ...
                        default='generic') # tipos de tratamentos realizados na imagem do jogo
...
# define função que pega o diretório de logs
